...
function printUsage() {
  console.log(
    'Usage: node examples/nodejs/example04_dx11_clear_window.js [--dll PATH] [--width 640] [--height 360] [--frames 180] [--color R,G,B,A] [--hidden] [--debug]'
  );
}
...
function main() {
  ...
  const window = new Win32Window('DXBridge Node.js Clear Window', width, height, !hidden, 'DXBridgeNodeClearWindow');
