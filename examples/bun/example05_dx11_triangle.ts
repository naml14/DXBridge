...
function printUsage(): void {
  console.log(
    "Usage: bun run examples/bun/example05_dx11_triangle.ts [--dll PATH] [--width 960] [--height 540] [--frames 0] [--speed 1.6] [--amplitude 0.38] [--hidden] [--debug] [--sync-interval 1]",
  );
}

function makeVertexData(offsetX: number, offsetY: number): Float32Array {
...
function main(): void {
  ...
  const window = new Win32Window("DXBridge Bun Triangle", width, height, !hidden, "DXBridgeBunTriangle");
